...
public class InjuryService {
    ...
    /**
     * Get all the injuries with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<InjuryDTO> findAllWithEagerRelationships(Pageable pageable) {
        return injuryRepository.findAllWithEagerRelationships(pageable).map(injuryMapper::toDto);
    }
    ...
    public Optional<InjuryDTO> findOne(Long id) {
        ...
        return injuryRepository.findOneWithEagerRelationships(id).map(injuryMapper::toDto);
    }
