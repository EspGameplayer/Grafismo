...
public class ActionKeyResource {
    ...
    public ResponseEntity<ActionKeyDTO> createActionKey(@Valid @RequestBody ActionKeyDTO actionKeyDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ActionKeyDTO> updateActionKey(
        ...
        @Valid @RequestBody ActionKeyDTO actionKeyDTO
    ...
    public ResponseEntity<ActionKeyDTO> partialUpdateActionKey(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody ActionKeyDTO actionKeyDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<ActionKeyDTO>> getAllActionKeys(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable,
        @RequestParam(required = false, defaultValue = "true") boolean eagerload
    ) {
        log.debug("REST request to get a page of ActionKeys");
        Page<ActionKeyDTO> page;
        if (eagerload) {
            page = actionKeyService.findAllWithEagerRelationships(pageable);
        } else {
            page = actionKeyService.findAll(pageable);
        }
