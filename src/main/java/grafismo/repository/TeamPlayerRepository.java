...
public interface TeamPlayerRepository extends JpaRepository<TeamPlayer, Long> {
    ...
    @Query(
        value = "select distinct teamPlayer from TeamPlayer teamPlayer left join fetch teamPlayer.team",
    ...
    @Query("select distinct teamPlayer from TeamPlayer teamPlayer left join fetch teamPlayer.team")
    List<TeamPlayer> findAllWithToOneRelationships();

    @Query("select teamPlayer from TeamPlayer teamPlayer left join fetch teamPlayer.team where teamPlayer.id =:id")
