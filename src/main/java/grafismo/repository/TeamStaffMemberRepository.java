...
public interface TeamStaffMemberRepository extends JpaRepository<TeamStaffMember, Long> {
    ...
    @Query(
        value = "select distinct teamStaffMember from TeamStaffMember teamStaffMember left join fetch teamStaffMember.team",
    ...
    @Query("select distinct teamStaffMember from TeamStaffMember teamStaffMember left join fetch teamStaffMember.team")
    List<TeamStaffMember> findAllWithToOneRelationships();

    @Query("select teamStaffMember from TeamStaffMember teamStaffMember left join fetch teamStaffMember.team where teamStaffMember.id =:id")
