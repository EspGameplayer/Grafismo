...
export class SponsorUpdateComponent implements OnInit {
  ...
  protected updateForm(sponsor: ISponsor): void {
    this.editForm.patchValue({
      id: sponsor.id,
      name: sponsor.name,
      graphicsName: sponsor.graphicsName,
      logo: sponsor.logo,
      logoContentType: sponsor.logoContentType,
      monocLogo: sponsor.monocLogo,
      monocLogoContentType: sponsor.monocLogoContentType,
      details: sponsor.details,
      miscData: sponsor.miscData,
    });
  }
  ...
  protected createFromForm(): ISponsor {
    return {
      ...
      monocLogoContentType: this.editForm.get(['monocLogoContentType'])!.value,
      monocLogo: this.editForm.get(['monocLogo'])!.value,
