...
export class SuspensionUpdateComponent implements OnInit {
  ...
  protected updateForm(suspension: ISuspension): void {
    ...
    this.matchesSharedCollection = this.matchService.addMatchToCollectionIfMissing(this.matchesSharedCollection, suspension.match);
  }
