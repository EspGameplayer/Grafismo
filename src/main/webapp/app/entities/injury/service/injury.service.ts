...
export class InjuryService {
  ...
  protected convertDateFromClient(injury: IInjury): IInjury {
    return Object.assign({}, injury, {
      ...
      estComebackDate: injury.estComebackDate?.isValid() ? injury.estComebackDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.estComebackDate = res.body.estComebackDate ? dayjs(res.body.estComebackDate) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((injury: IInjury) => {
        ...
        injury.estComebackDate = injury.estComebackDate ? dayjs(injury.estComebackDate) : undefined;
      });
    }
    return res;
  }
