...
describe('Injury Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      moment: currentDate,
      estHealingTime: 'AAAAAAA',
      estComebackDate: currentDate,
      reason: 'AAAAAAA',
    };
  });
  ...
  describe('Service methods', () => {
      ...
      const returnedFromService = Object.assign(
        {
          ...
          estComebackDate: currentDate.format(DATE_TIME_FORMAT),
        },
        elemDefault
      );
    ...
    describe('addInjuryToCollectionIfMissing', () => {
      ...
      it('should add only unique Injury to an array', () => {
        const injuryArray: IInjury[] = [{ id: 123 }, { id: 456 }, { id: 36541 }];
