...
describe('Person Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Location query and add missing value', () => {
      const person: IPerson = { id: 456 };
      const birthplace: ILocation = { id: 72997 };
      person.birthplace = birthplace;

      const locationCollection: ILocation[] = [{ id: 75548 }];
      jest.spyOn(locationService, 'query').mockReturnValue(of(new HttpResponse({ body: locationCollection })));
      const additionalLocations = [birthplace];
    ...
    it('Should update editForm', () => {
      ...
      person.nationality = nationality;
      const birthplace: ILocation = { id: 50922 };
      person.birthplace = birthplace;
      ...
      expect(comp.locationsSharedCollection).toContain(birthplace);
    });
  });
