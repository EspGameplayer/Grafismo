...
describe('Person Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      birthDate: 'AAAAAAA',
      deathDate: 'AAAAAAA',
      mediumShotPhotoContentType: 'image/png',
      mediumShotPhoto: 'AAAAAAA',
      fullShotPhotoContentType: 'image/png',
      fullShotPhoto: 'AAAAAAA',
      socialMedia: 'AAAAAAA',
      details: 'AAAAAAA',
      miscData: 'AAAAAAA',
    };
      ...
      const returnedFromService = Object.assign(
        {
          ...
          birthDate: 'BBBBBB',
          deathDate: 'BBBBBB',
          mediumShotPhoto: 'BBBBBB',
          fullShotPhoto: 'BBBBBB',
          socialMedia: 'BBBBBB',
          details: 'BBBBBB',
          miscData: 'BBBBBB',
        },
