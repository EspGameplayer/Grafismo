...
describe('TeamPlayer routing resolve service', () => {
  ...
  let resultTeamPlayer: ITeamPlayer | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ITeamPlayer if id is not provided', () => {
      // GIVEN
      ...
      expect(resultTeamPlayer).toEqual(new TeamPlayer());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as TeamPlayer })));
      mockActivatedRouteSnapshot.params = { id: 123 };
