...
describe('StaffMember Management Component', () => {
  let comp: StaffMemberComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StaffMemberComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.staffMembers[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
