...
describe('GraphicElement Management Component', () => {
  let comp: GraphicElementComponent;
  let fixture: ComponentFixture<GraphicElementComponent>;
  let service: GraphicElementService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      declarations: [GraphicElementComponent],
    })
      .overrideTemplate(GraphicElementComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(GraphicElementComponent);
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.graphicElements[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
