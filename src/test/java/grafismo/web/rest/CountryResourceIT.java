...
class CountryResourceIT {
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getCensusYear()).isEqualTo(DEFAULT_CENSUS_YEAR);
        assertThat(testCountry.getDenonym()).isEqualTo(DEFAULT_DENONYM);
    }
    ...
    void putNewCountry() throws Exception {
        ...
        assertThat(testCountry.getCensusYear()).isEqualTo(UPDATED_CENSUS_YEAR);
        assertThat(testCountry.getDenonym()).isEqualTo(UPDATED_DENONYM);
    }
