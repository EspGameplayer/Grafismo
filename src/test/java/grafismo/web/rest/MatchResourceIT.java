...
class MatchResourceIT {
    ...
    private static final Integer DEFAULT_ATTENDANCE = 1;
    private static final Integer UPDATED_ATTENDANCE = 2;
    ...
    void createMatch() throws Exception {
        ...
        assertThat(testMatch.getHashtag()).isEqualTo(DEFAULT_HASHTAG);
        assertThat(testMatch.getDetails()).isEqualTo(DEFAULT_DETAILS);
        assertThat(testMatch.getMiscData()).isEqualTo(DEFAULT_MISC_DATA);
    }
    ...
    void putNewMatch() throws Exception {
        ...
        assertThat(testMatch.getHashtag()).isEqualTo(UPDATED_HASHTAG);
        assertThat(testMatch.getDetails()).isEqualTo(UPDATED_DETAILS);
        assertThat(testMatch.getMiscData()).isEqualTo(UPDATED_MISC_DATA);
    }
    ...
    void partialUpdateMatchWithPatch() throws Exception {
        ...
        partialUpdatedMatch.attendance(UPDATED_ATTENDANCE).hashtag(UPDATED_HASHTAG).details(UPDATED_DETAILS).miscData(UPDATED_MISC_DATA);
