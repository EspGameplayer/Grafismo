...
class BroadcastPersonnelMemberResourceIT {
    ...
    public static BroadcastPersonnelMember createEntity(EntityManager em) {
        BroadcastPersonnelMember broadcastPersonnelMember = new BroadcastPersonnelMember()
    ...
    void createBroadcastPersonnelMember() throws Exception {
        ...
        assertThat(testBroadcastPersonnelMember.getGraphicsName()).isEqualTo(DEFAULT_GRAPHICS_NAME);
        assertThat(testBroadcastPersonnelMember.getLongGraphicsName()).isEqualTo(DEFAULT_LONG_GRAPHICS_NAME);
    ...
    void checkGraphicsNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = broadcastPersonnelMemberRepository.findAll().size();
        // set the field null
        broadcastPersonnelMember.setGraphicsName(null);

        // Create the BroadcastPersonnelMember, which fails.
        BroadcastPersonnelMemberDTO broadcastPersonnelMemberDTO = broadcastPersonnelMemberMapper.toDto(broadcastPersonnelMember);
        ...
        List<BroadcastPersonnelMember> broadcastPersonnelMemberList = broadcastPersonnelMemberRepository.findAll();
        assertThat(broadcastPersonnelMemberList).hasSize(databaseSizeBeforeTest);
    }
    ...
    void putNewBroadcastPersonnelMember() throws Exception {
        ...
        updatedBroadcastPersonnelMember.graphicsName(UPDATED_GRAPHICS_NAME).longGraphicsName(UPDATED_LONG_GRAPHICS_NAME).role(UPDATED_ROLE);
        ...
        BroadcastPersonnelMember testBroadcastPersonnelMember = broadcastPersonnelMemberList.get(broadcastPersonnelMemberList.size() - 1);
        assertThat(testBroadcastPersonnelMember.getGraphicsName()).isEqualTo(UPDATED_GRAPHICS_NAME);
        assertThat(testBroadcastPersonnelMember.getLongGraphicsName()).isEqualTo(UPDATED_LONG_GRAPHICS_NAME);
    ...
    void fullUpdateBroadcastPersonnelMemberWithPatch() throws Exception {
        ...
        partialUpdatedBroadcastPersonnelMember
            .graphicsName(UPDATED_GRAPHICS_NAME)
            .longGraphicsName(UPDATED_LONG_GRAPHICS_NAME)
            .role(UPDATED_ROLE);
