...
class SystemConfigurationResourceIT {
    ...
    public static SystemConfiguration createEntity(EntityManager em) {
        SystemConfiguration systemConfiguration = new SystemConfiguration().miscData(DEFAULT_MISC_DATA);
    ...
    public static SystemConfiguration createUpdatedEntity(EntityManager em) {
        SystemConfiguration systemConfiguration = new SystemConfiguration().miscData(UPDATED_MISC_DATA);
        return systemConfiguration;
    }
    ...
    void createSystemConfiguration() throws Exception {
        ...
        assertThat(testSystemConfiguration.getMiscData()).isEqualTo(DEFAULT_MISC_DATA);
    }
    ...
    void putNewSystemConfiguration() throws Exception {
        ...
        updatedSystemConfiguration.miscData(UPDATED_MISC_DATA);
        ...
        SystemConfiguration testSystemConfiguration = systemConfigurationList.get(systemConfigurationList.size() - 1);
        assertThat(testSystemConfiguration.getMiscData()).isEqualTo(UPDATED_MISC_DATA);
    }
    ...
    void fullUpdateSystemConfigurationWithPatch() throws Exception {
        ...
        partialUpdatedSystemConfiguration.miscData(UPDATED_MISC_DATA);
