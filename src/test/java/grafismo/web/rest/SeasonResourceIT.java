...
class SeasonResourceIT {
    ...
    void createSeason() throws Exception {
        ...
        assertThat(testSeason.getGraphicsName()).isEqualTo(DEFAULT_GRAPHICS_NAME);
    ...
    void putNewSeason() throws Exception {
        ...
        updatedSeason.name(UPDATED_NAME).graphicsName(UPDATED_GRAPHICS_NAME).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
        ...
        assertThat(testSeason.getGraphicsName()).isEqualTo(UPDATED_GRAPHICS_NAME);
    ...
    void partialUpdateSeasonWithPatch() throws Exception {
        ...
        partialUpdatedSeason.graphicsName(UPDATED_GRAPHICS_NAME);
    ...
    void fullUpdateSeasonWithPatch() throws Exception {
        ...
        partialUpdatedSeason.name(UPDATED_NAME).graphicsName(UPDATED_GRAPHICS_NAME).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
