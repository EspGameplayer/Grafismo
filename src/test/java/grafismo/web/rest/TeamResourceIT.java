...
class TeamResourceIT {
    ...
    private static final String DEFAULT_ESTABLISHMENT_DATE = "AAAAAAAAAA";
    private static final String UPDATED_ESTABLISHMENT_DATE = "BBBBBBBBBB";
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team()
            ...
            .establishmentDate(DEFAULT_ESTABLISHMENT_DATE)
            .badge(DEFAULT_BADGE)
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team()
            ...
            .establishmentDate(UPDATED_ESTABLISHMENT_DATE)
            .badge(UPDATED_BADGE)
    ...
    void createTeam() throws Exception {
        ...
        assertThat(testTeam.getNicknames()).isEqualTo(DEFAULT_NICKNAMES);
        assertThat(testTeam.getEstablishmentDate()).isEqualTo(DEFAULT_ESTABLISHMENT_DATE);
        ...
        assertThat(testTeam.getDetails()).isEqualTo(DEFAULT_DETAILS);
        assertThat(testTeam.getMiscData()).isEqualTo(DEFAULT_MISC_DATA);
    }
    ...
    void getAllTeams() throws Exception {
        ...
        restTeamMockMvc
            ...
            .andExpect(jsonPath("$.[*].establishmentDate").value(hasItem(DEFAULT_ESTABLISHMENT_DATE)))
    ...
    void getTeam() throws Exception {
        ...
        restTeamMockMvc
            ...
            .andExpect(jsonPath("$.establishmentDate").value(DEFAULT_ESTABLISHMENT_DATE))
    ...
    void putNewTeam() throws Exception {
        ...
        assertThat(testTeam.getNicknames()).isEqualTo(UPDATED_NICKNAMES);
        assertThat(testTeam.getEstablishmentDate()).isEqualTo(UPDATED_ESTABLISHMENT_DATE);
        ...
        assertThat(testTeam.getDetails()).isEqualTo(UPDATED_DETAILS);
        assertThat(testTeam.getMiscData()).isEqualTo(UPDATED_MISC_DATA);
    }
