...
class StaffMemberResourceIT {
    ...
    void createStaffMember() throws Exception {
        ...
        assertThat(testStaffMember.getGraphicsName()).isEqualTo(DEFAULT_GRAPHICS_NAME);
        assertThat(testStaffMember.getLongGraphicsName()).isEqualTo(DEFAULT_LONG_GRAPHICS_NAME);
    ...
    void checkGraphicsNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = staffMemberRepository.findAll().size();
        // set the field null
        staffMember.setGraphicsName(null);

        // Create the StaffMember, which fails.
        StaffMemberDTO staffMemberDTO = staffMemberMapper.toDto(staffMember);
        ...
        List<StaffMember> staffMemberList = staffMemberRepository.findAll();
        assertThat(staffMemberList).hasSize(databaseSizeBeforeTest);
    }
    ...
    void putNewStaffMember() throws Exception {
        ...
        StaffMember testStaffMember = staffMemberList.get(staffMemberList.size() - 1);
        assertThat(testStaffMember.getGraphicsName()).isEqualTo(UPDATED_GRAPHICS_NAME);
        assertThat(testStaffMember.getLongGraphicsName()).isEqualTo(UPDATED_LONG_GRAPHICS_NAME);
