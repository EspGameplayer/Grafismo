...
class LineupResourceIT {
    ...
    public static Lineup createEntity(EntityManager em) {
        Lineup lineup = new Lineup().details(DEFAULT_DETAILS).miscData(DEFAULT_MISC_DATA);
        // Add required entity
        Match match;
        ...
        lineup.setHomeMatch(match);
        // Add required entity
        lineup.setAwayMatch(match);
        return lineup;
    }
    ...
    public static Lineup createUpdatedEntity(EntityManager em) {
        Lineup lineup = new Lineup().details(UPDATED_DETAILS).miscData(UPDATED_MISC_DATA);
        // Add required entity
        Match match;
        if (TestUtil.findAll(em, Match.class).isEmpty()) {
    ...
    void createLineup() throws Exception {
        ...
        assertThat(testLineup.getDetails()).isEqualTo(DEFAULT_DETAILS);
        assertThat(testLineup.getMiscData()).isEqualTo(DEFAULT_MISC_DATA);
    }
    ...
    void putNewLineup() throws Exception {
        ...
        updatedLineup.details(UPDATED_DETAILS).miscData(UPDATED_MISC_DATA);
        ...
        Lineup testLineup = lineupList.get(lineupList.size() - 1);
        assertThat(testLineup.getDetails()).isEqualTo(UPDATED_DETAILS);
        assertThat(testLineup.getMiscData()).isEqualTo(UPDATED_MISC_DATA);
    }
    ...
    void partialUpdateLineupWithPatch() throws Exception {
        ...
        partialUpdatedLineup.miscData(UPDATED_MISC_DATA);
    ...
    void fullUpdateLineupWithPatch() throws Exception {
        ...
        partialUpdatedLineup.details(UPDATED_DETAILS).miscData(UPDATED_MISC_DATA);
