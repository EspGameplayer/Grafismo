...
class FormationResourceIT {
    ...
    private static final String DEFAULT_DETAILED_NAME = "AAAAAAAAAA";
    private static final String UPDATED_DETAILED_NAME = "BBBBBBBBBB";
    ...
    public static Formation createEntity(EntityManager em) {
        Formation formation = new Formation()
            ...
            .detailedName(DEFAULT_DETAILED_NAME)
    ...
    public static Formation createUpdatedEntity(EntityManager em) {
        Formation formation = new Formation()
            ...
            .detailedName(UPDATED_DETAILED_NAME)
    ...
    void createFormation() throws Exception {
        ...
        assertThat(testFormation.getGraphicsName()).isEqualTo(DEFAULT_GRAPHICS_NAME);
        assertThat(testFormation.getDetailedName()).isEqualTo(DEFAULT_DETAILED_NAME);
    ...
    void checkGraphicsNameIsRequired() throws Exception {
        ...
        // set the field null
        formation.setGraphicsName(null);
    ...
    void getAllFormations() throws Exception {
        ...
        restFormationMockMvc
            ...
            .andExpect(jsonPath("$.[*].detailedName").value(hasItem(DEFAULT_DETAILED_NAME)))
    ...
    void getFormation() throws Exception {
        ...
        restFormationMockMvc
            ...
            .andExpect(jsonPath("$.detailedName").value(DEFAULT_DETAILED_NAME))
    ...
    void putNewFormation() throws Exception {
        ...
        updatedFormation.graphicsName(UPDATED_GRAPHICS_NAME).detailedName(UPDATED_DETAILED_NAME).distribution(UPDATED_DISTRIBUTION);
        ...
        Formation testFormation = formationList.get(formationList.size() - 1);
        assertThat(testFormation.getGraphicsName()).isEqualTo(UPDATED_GRAPHICS_NAME);
        assertThat(testFormation.getDetailedName()).isEqualTo(UPDATED_DETAILED_NAME);
    ...
    void fullUpdateFormationWithPatch() throws Exception {
        ...
        partialUpdatedFormation.graphicsName(UPDATED_GRAPHICS_NAME).detailedName(UPDATED_DETAILED_NAME).distribution(UPDATED_DISTRIBUTION);
