...
class MatchdayResourceIT {
    ...
    void createMatchday() throws Exception {
        ...
        assertThat(testMatchday.getMoment()).isEqualTo(DEFAULT_MOMENT);
        assertThat(testMatchday.getDetails()).isEqualTo(DEFAULT_DETAILS);
        assertThat(testMatchday.getMiscData()).isEqualTo(DEFAULT_MISC_DATA);
    }
    ...
    void putNewMatchday() throws Exception {
        ...
        assertThat(testMatchday.getMoment()).isEqualTo(UPDATED_MOMENT);
        assertThat(testMatchday.getDetails()).isEqualTo(UPDATED_DETAILS);
        assertThat(testMatchday.getMiscData()).isEqualTo(UPDATED_MISC_DATA);
    }
    ...
    void partialUpdateMatchdayWithPatch() throws Exception {
        ...
        partialUpdatedMatchday.name(UPDATED_NAME).graphicsName(UPDATED_GRAPHICS_NAME).details(UPDATED_DETAILS);
