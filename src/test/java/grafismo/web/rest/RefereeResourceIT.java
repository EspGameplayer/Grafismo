...
class RefereeResourceIT {
    ...
    void createReferee() throws Exception {
        ...
        assertThat(testReferee.getGraphicsName()).isEqualTo(DEFAULT_GRAPHICS_NAME);
        assertThat(testReferee.getLongGraphicsName()).isEqualTo(DEFAULT_LONG_GRAPHICS_NAME);
        assertThat(testReferee.getRetirementDate()).isEqualTo(DEFAULT_RETIREMENT_DATE);
        assertThat(testReferee.getMiscData()).isEqualTo(DEFAULT_MISC_DATA);
    }
    ...
    void checkGraphicsNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = refereeRepository.findAll().size();
        // set the field null
        referee.setGraphicsName(null);
    ...
    void putNewReferee() throws Exception {
        ...
        Referee testReferee = refereeList.get(refereeList.size() - 1);
        assertThat(testReferee.getGraphicsName()).isEqualTo(UPDATED_GRAPHICS_NAME);
        assertThat(testReferee.getLongGraphicsName()).isEqualTo(UPDATED_LONG_GRAPHICS_NAME);
        assertThat(testReferee.getRetirementDate()).isEqualTo(UPDATED_RETIREMENT_DATE);
        assertThat(testReferee.getMiscData()).isEqualTo(UPDATED_MISC_DATA);
    }
