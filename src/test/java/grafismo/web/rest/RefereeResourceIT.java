...
class RefereeResourceIT {
    ...
    public static Referee createEntity(EntityManager em) {
        Referee referee = new Referee().retirementDate(DEFAULT_RETIREMENT_DATE).miscData(DEFAULT_MISC_DATA);
        // Add required entity
        Person person;
    ...
    public static Referee createUpdatedEntity(EntityManager em) {
        Referee referee = new Referee().retirementDate(UPDATED_RETIREMENT_DATE).miscData(UPDATED_MISC_DATA);
        // Add required entity
        Person person;
        if (TestUtil.findAll(em, Person.class).isEmpty()) {
    ...
    void putNewReferee() throws Exception {
        ...
        updatedReferee.retirementDate(UPDATED_RETIREMENT_DATE).miscData(UPDATED_MISC_DATA);
    ...
    void fullUpdateRefereeWithPatch() throws Exception {
        ...
        partialUpdatedReferee.retirementDate(UPDATED_RETIREMENT_DATE).miscData(UPDATED_MISC_DATA);
