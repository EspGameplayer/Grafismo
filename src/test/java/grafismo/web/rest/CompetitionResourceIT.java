...
class CompetitionResourceIT {
    ...
    private static final CompetitionType UPDATED_TYPE = CompetitionType.LEAGUE2;

    private static final String DEFAULT_COLOUR = "";
    private static final String UPDATED_COLOUR = "B";

    private static final String DEFAULT_REGULATIONS = "AAAAAAAAAA";
    private static final String UPDATED_REGULATIONS = "BBBBBBBBBB";
    ...
    public static Competition createUpdatedEntity(EntityManager em) {
        Competition competition = new Competition()
            ...
            .regulations(UPDATED_REGULATIONS)
    ...
    void createCompetition() throws Exception {
        ...
        assertThat(testCompetition.getRegulations()).isEqualTo(DEFAULT_REGULATIONS);
        assertThat(testCompetition.getDetails()).isEqualTo(DEFAULT_DETAILS);
        assertThat(testCompetition.getMiscData()).isEqualTo(DEFAULT_MISC_DATA);
    }
    ...
    void getAllCompetitions() throws Exception {
        ...
        restCompetitionMockMvc
            ...
            .andExpect(jsonPath("$.[*].regulations").value(hasItem(DEFAULT_REGULATIONS)))
    ...
    void getCompetition() throws Exception {
        ...
        restCompetitionMockMvc
            ...
            .andExpect(jsonPath("$.regulations").value(DEFAULT_REGULATIONS))
    ...
    void putNewCompetition() throws Exception {
        ...
        assertThat(testCompetition.getRegulations()).isEqualTo(UPDATED_REGULATIONS);
        assertThat(testCompetition.getDetails()).isEqualTo(UPDATED_DETAILS);
        assertThat(testCompetition.getMiscData()).isEqualTo(UPDATED_MISC_DATA);
    }
    ...
    void partialUpdateCompetitionWithPatch() throws Exception {
        ...
        partialUpdatedCompetition.name(UPDATED_NAME).type(UPDATED_TYPE).regulations(UPDATED_REGULATIONS);
