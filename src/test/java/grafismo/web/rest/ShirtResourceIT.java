...
class ShirtResourceIT {
    ...
    private static final byte[] DEFAULT_MODEL = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_MODEL = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_MODEL_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_MODEL_CONTENT_TYPE = "image/png";
    ...
    public static Shirt createEntity(EntityManager em) {
        Shirt shirt = new Shirt()
            ...
            .type(DEFAULT_TYPE)
            .model(DEFAULT_MODEL)
            .modelContentType(DEFAULT_MODEL_CONTENT_TYPE)
            .photo(DEFAULT_PHOTO)
    ...
    public static Shirt createUpdatedEntity(EntityManager em) {
        Shirt shirt = new Shirt()
            .colour1(UPDATED_COLOUR_1)
            .colour2(UPDATED_COLOUR_2)
            .type(UPDATED_TYPE)
            .model(UPDATED_MODEL)
            .modelContentType(UPDATED_MODEL_CONTENT_TYPE)
            .photo(UPDATED_PHOTO)
    ...
    void createShirt() throws Exception {
        ...
        assertThat(testShirt.getModel()).isEqualTo(DEFAULT_MODEL);
        assertThat(testShirt.getModelContentType()).isEqualTo(DEFAULT_MODEL_CONTENT_TYPE);
        assertThat(testShirt.getPhoto()).isEqualTo(DEFAULT_PHOTO);
        assertThat(testShirt.getPhotoContentType()).isEqualTo(DEFAULT_PHOTO_CONTENT_TYPE);
    }
    ...
    void getAllShirts() throws Exception {
        ...
        restShirtMockMvc
            ...
            .andExpect(jsonPath("$.[*].modelContentType").value(hasItem(DEFAULT_MODEL_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].model").value(hasItem(Base64Utils.encodeToString(DEFAULT_MODEL))))
    ...
    void getShirt() throws Exception {
        ...
        restShirtMockMvc
            ...
            .andExpect(jsonPath("$.modelContentType").value(DEFAULT_MODEL_CONTENT_TYPE))
            .andExpect(jsonPath("$.model").value(Base64Utils.encodeToString(DEFAULT_MODEL)))
    ...
    void putNewShirt() throws Exception {
        ...
        assertThat(testShirt.getModel()).isEqualTo(UPDATED_MODEL);
        assertThat(testShirt.getModelContentType()).isEqualTo(UPDATED_MODEL_CONTENT_TYPE);
        assertThat(testShirt.getPhoto()).isEqualTo(UPDATED_PHOTO);
        assertThat(testShirt.getPhotoContentType()).isEqualTo(UPDATED_PHOTO_CONTENT_TYPE);
    }
    ...
    void partialUpdateShirtWithPatch() throws Exception {
        ...
        partialUpdatedShirt.type(UPDATED_TYPE).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
